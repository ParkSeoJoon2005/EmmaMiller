...
from EmmaMiller.modules import ALL_MODULES
from EmmaMiller.modules.helper_funcs.alternate import typing_action
from EmmaMiller.modules.helper_funcs.chat_status import is_user_admin
from EmmaMiller.modules.helper_funcs.misc import paginate_modules
from EmmaMiller.modules.helper_funcs.readable_time import get_readable_time
...
def EmmaMiller_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f" @EmmaMillerBot - A bot to manage your groups with additional features!"
            f"\n\n Here's the basic help regarding use of @EmmaMillerBot."
        ...
        query.message.edit_text(
            ...
            f"\n\n Than send `/admincache@EmmaMillerBot` in that chat to refresh admin list in My database.\n"
